...
static int convert_image_cpu(image_buffer_t *src, image_buffer_t *dst, sam_image_rect_t *src_box, sam_image_rect_t *dst_box, char color) {
    int ret;
...
static int convert_image_rga(image_buffer_t* src_img, image_buffer_t* dst_img, sam_image_rect_t* src_box, sam_image_rect_t* dst_box, char color)
{
    int ret = 0;
...
int convert_image(image_buffer_t* src_img, image_buffer_t* dst_img, sam_image_rect_t* src_box, sam_image_rect_t* dst_box, char color)
{
    int ret;
...
int convert_image_with_letterbox(image_buffer_t* src_image, image_buffer_t* dst_image, sam_letterbox_t* letterbox, char color)
{
    int ret = 0;
