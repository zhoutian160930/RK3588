...
#include "mobilesam.h"
#include "mobilesam_common.h"
#include "file_utils.h"
#include "image_utils.h"


int init_mobilesam_model(const char* encoder_model_path, const char* decoder_model_path, mobilesam_app_context_t* app_ctx)
{
    int ret;
...
int release_mobilesam_model(mobilesam_app_context_t* app_ctx)
{
...
int inference_mobilesam_model(mobilesam_app_context_t* app_ctx, image_buffer_t* img, float* point_coords, float* point_labels, mobilesam_res* res)
{
    int ret;
    int* tokens;
